...
#if ASSERTIONS
function checkForReplacedModuleProp(prop, newName) {
...
function reportIgnoredModuleProp(prop) {
  if (Object.getOwnPropertyDescriptor(Module, prop)) {
    abort('`Module.' + prop + '` was supplied but `' + prop + '` not incluced in INCOMING_MODULE_JS_API');
  }
}
#endif
